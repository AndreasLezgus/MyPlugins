...
What should someone think about you after reading one of your articles?

“An interesting approach that helps me in my development. The author has experience and lets me benefit from it. This way, I can learn and grow faster. I can quickly put this into context and make it useful for myself.”
...
## 5. Tone Spectrum
Short, punchy sentences. No nested clauses or long-winded passages that keep repeating themselves. Three sentences, three thoughts, no explicit connectors — the logic stays implicit. Em dashes yes, semicolons no.
...
**Patterns** Open questions that prompt self-reflection. Let the reader reach the conclusion on their own. Describing it simply and getting to the point — that's the real art. Thesis (blunt, direct, nouns stacked) + rhetorical question with an accusation baked in. The question isn't friendly curiosity — it's an indictment.
**Sample opening:** "Adequate security, scalable infrastructure, and sustainably good data are mission-critical. So why do they only get serious attention at the tail end of AI pilots?"
...
No references to the source documents, and always adapt the articles so that any reference is difficult to detect.

**Natural Variation** Real authors aren’t perfectly consistent. Build in natural variation:
- Don’t start every text the same way just because I have a “signature opening”
- Don’t avoid a word forever just because I said I don’t like it — sometimes it’s the right word
- Let the content determine the structure, not the template

## 7. Terminology
Preferred and avoided terms. No references to the BKA. Otherwise, just a nod to hands-on experience from previous roles.
...
1.	My most important belief about writing: Describing things simply and getting to the point is the real art. Concrete examples from my own practice beat abstract theories.

2.	The one pattern that makes my voice distinctive: Experience-based authority paired with constructive critique — I cite specific numbers, specific projects, specific contexts, and I always end with a path forward.
	
3.	The #1 thing I never do: Criticism without a solution, names without protection, opinions without experience.
